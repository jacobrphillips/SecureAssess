    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserCompany", x => new { x.CompaniesId, x.ContactsId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_AppUserCompany_Users_ContactsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AssessmentStatus_Assessments_AssessmentId",
                        column: x => x.AssessmentId,
                        principalTable: "Assessments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssessmentStatus_Users_UpdatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Questionnaires_Assessments_AssessmentId",
                        column: x => x.AssessmentId,
                        principalTable: "Assessments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VulnerabilityReports_Assessments_AssessmentId",
                        column: x => x.AssessmentId,
                        principalTable: "Assessments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VulnerabilityReports_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserCompany_ContactsId",
                table: "AppUserCompany",
                column: "ContactsId");

            migrationBuilder.CreateIndex(
                name: "IX_AssessmentStatus_AssessmentId",
                table: "AssessmentStatus",
                column: "AssessmentId");

            migrationBuilder.CreateIndex(
                name: "IX_AssessmentStatus_UpdatedById",
                table: "AssessmentStatus",
                column: "UpdatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questionnaires_AssessmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VulnerabilityReports_AssessmentId",
                table: "VulnerabilityReports",
                column: "AssessmentId");

            migrationBuilder.CreateIndex(
                name: "IX_VulnerabilityReports_CompanyId",
                table: "VulnerabilityReports",
                column: "CompanyId");
        }
